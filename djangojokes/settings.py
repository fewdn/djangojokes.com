...
SECRET_KEY = 'django-insecure-^ne7!o1d=ewn+-14p$&zv+iv!a*)d&t1yyun$mniv$%&x-v#wn'
...
MIDDLEWARE = [
    ...
    # Third party - migrate won't work without this
...
ACCOUNT_EMAIL_VERIFICATION = 'mandatory' # Default: 'optional'  or 'none' for no email
...
AWS_STORAGE_BUCKET_NAME = 'django-jokes-app-student' # REPLACE WITH YOUR BUCKET NAME
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',   # A project-based static files directory
]
...
# static files are local for development only
